import React__default, { memo, createElement, useState, forwardRef, useEffect, Fragment as Fragment$1, useRef, useReducer, createContext, useContext, useMemo } from 'react';
...
var Accordion = styled$1(function (props) {
...
var AccordionSummary = styled$1(function (props) {
...
var AccordionDetails = styled$1(MuiAccordionDetails)(function (_ref3) {
...
var BootstrapDialog = styled$1(Dialog)(function (_ref) {
  var theme = _ref.theme;
  return {
...
var CustomDataTable = function CustomDataTable(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Fragment$1, null, title && /*#__PURE__*/React__default.createElement(Typography$1, {
    className: "title-table-custom"
  }, title), /*#__PURE__*/React__default.createElement(DataTable, {
    className: displayBorder ? 'content-data-table-display-border' : 'custom-data-table-content',
    value: records,
    style: {
      width: '100%'
    },
...
function HeaderApp(_ref) {
  ...
  return /*#__PURE__*/createElement(Box$1, {
    sx: style$9,
    onClick: onClick
  }, /*#__PURE__*/createElement("div", {
    className: "box-menu"
...
var Search = styled$1('div')(function (_ref) {
  var _ref2;
  var theme = _ref.theme;
  return _ref2 = {
    position: 'relative',
...
var SearchIconWrapper = styled$1('div')(function (_ref3) {
  var theme = _ref3.theme;
  return {
...
var StyledInputBase = styled$1(InputBase)(function (_ref4) {
...
var Header = function Header(_ref) {
  ...
  }), manageAccess && roleUserAGSI() && /*#__PURE__*/createElement(Fragment$1, null, /*#__PURE__*/createElement(MenuItem, {
    onClick: function onClick() {
      handleMenuClose();
  ...
  return /*#__PURE__*/createElement(Box$1, {
    ...
    title: "Menu"
  }, /*#__PURE__*/createElement(MenuIcon, null))), /*#__PURE__*/createElement(Box$1, null, /*#__PURE__*/createElement(Typography, {
    variant: "h6",
    noWrap: true,
    component: "div",
    sx: {
  ...
  }, title)), /*#__PURE__*/createElement(Box$1, {
    sx: {
      flexGrow: 1
    }
  }), /*#__PURE__*/createElement(Box$1, {
...
var CustomTextField = function CustomTextField(_ref) {
  ...
  if (type && type == 'amount') {
    return /*#__PURE__*/React__default.createElement(NumericFormat, _extends({
      id: id,
      size: "small",
      label: label,
      style: {
...
var CustomBeneficiarieFields = function CustomBeneficiarieFields(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: "custom-beneficiarie-field-content"
  }, /*#__PURE__*/React__default.createElement(ConteinerItem, {
    ...
    className: "custom-beneficiarie-field-name"
  }, /*#__PURE__*/React__default.createElement(CustomInputSelect$1, {
...
var ArchivesContent = function ArchivesContent(_ref) {
  ...
  }))), editable && /*#__PURE__*/React__default.createElement(Fragment$1, null, /*#__PURE__*/React__default.createElement("input", {
    accept: ".pdf,image/*",
    style: {
      display: 'none'
    },
...
var FilesContentApi = function FilesContentApi(_ref) {
  ...
  }))), loadChange && /*#__PURE__*/React__default.createElement(LinearProgress, null), editable && /*#__PURE__*/React__default.createElement(Fragment$1, null, /*#__PURE__*/React__default.createElement("input", {
    accept: ".pdf,image/*",
    style: {
      display: 'none'
    },
...
function FieldsChecklist() {
  ...
  return /*#__PURE__*/createElement(Box$1, null, /*#__PURE__*/createElement(Typography, {
    variant: "h5",
    gutterBottom: true,
    sx: {
      color: '#455a64'
...
var Agrupamento = function Agrupamento(_ref) {
  ...
  var _useSelectedRegisters = useSelectedRegisters(),
    ...
    dispatch = _useSelectedRegisters.dispatch;
  var _useState = useState(savedTree),
    tree = _useState[0],
    setTree = _useState[1];
  var _useState2 = useState(savedTree.some(function (obj) {
      return obj.id === 11;
    })),
    secondLevel = _useState2[0],
    setSecondLevel = _useState2[1];
  var _useState3 = useState(formatExternalNodes(checkedFields, savedTree)),
...
var DynaGrade = function DynaGrade(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(DataTable, {
    className: "mypanel",
    value: registers,
...
var Principal = function Principal(_ref) {
  ...
  var Item = styled$1(Paper$1)(function (_ref2) {
    var theme = _ref2.theme;
    return _extends({
      backgroundColor: '#fff'
  ...
  if (error) {
    return /*#__PURE__*/React__default.createElement(Grid, {
      ...
      fontSize: "large"
    }), /*#__PURE__*/React__default.createElement(Typography$1, null, "N\xE3o foi poss\xEDvel se comunicar com o servidor"), /*#__PURE__*/React__default.createElement(Button, {
      onClick: handleFetch
    }, "Tentar novamente"));
  }
  return /*#__PURE__*/React__default.createElement(Box$1, {
...
var CustomSimpleModal = function CustomSimpleModal(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement(Fragment$1, null, /*#__PURE__*/React__default.createElement(Box$2, {
  ...
  }, children), footer && /*#__PURE__*/React__default.createElement(Box$2, {
    className: "simple-modal-footer-content"
  }, exitClick && /*#__PURE__*/React__default.createElement(Button$2, {
    className: "simple-modal-button-footer " + exitClassName,
    startIcon: exitIcon && exitIcon,
    variant: exitVariant && exitVariant,
    onClick: exitClick
  }, exitTitle ? exitTitle : 'Fechar'), confirmClick && /*#__PURE__*/React__default.createElement(Button$2, {
...
CustomSimpleModal.defaultProp = {
  ...
  exitTitle: '',
  exitIcon: /*#__PURE__*/React__default.createElement(Fragment$1, null),
  exitVariant: '',
  exitClassName: '',
  confirmClick: function confirmClick() {},
  confirmTitle: '',
  confirmIcon: /*#__PURE__*/React__default.createElement(Fragment$1, null),
  confirmVariant: '',
  confirmClassName: ''
};
...
OperationTab.defaultProp = {
  menuList: [],
  childrenList: [],
  footer: /*#__PURE__*/React__default.createElement(Fragment$1, null),
  className: '',
  classNameChildren: '',
  disableRipple: false,
  tabIndicatorProps: {}
...
function spacing(props) {
  return style$g(props, spacingKeys);
}
...
const sizeWidth = style$f({
  prop: 'size',
  cssProperty: 'width',
  transform: sizingTransform
});
const sizeHeight = style$f({
  prop: 'size',
  cssProperty: 'height',
  transform: sizingTransform
});
...
function createBox(options = {}) {
  ...
  const Box = /*#__PURE__*/forwardRef(function Box(inProps, ref) {
...
var CustomContentReport = function CustomContentReport(_ref) {
  ...
  var HandleSearchButton = function HandleSearchButton() {
    if (_onClick) return /*#__PURE__*/React__default.createElement(Button$2, {
      className: "btn-blue",
  ...
  }, /*#__PURE__*/React__default.createElement(Fragment$1, null, children), /*#__PURE__*/React__default.createElement(ConteinerItem, {
...
var CustomStepForm = function CustomStepForm(_ref) {
  ...
  var _useState = useState(activeStep | 0),
    step = _useState[0],
    setStep = _useState[1];
  useEffect(function () {
  ...
  return /*#__PURE__*/React__default.createElement(Fragment$1, null, /*#__PURE__*/React__default.createElement(Box$1, {
    ...
    disabled: step == 0
  }, "Voltar"), /*#__PURE__*/React__default.createElement(Button$2, {
    variant: "contained",
...
var CustomRadioGroup = function CustomRadioGroup(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(FormControl$1, {
    className: className
  }, title && /*#__PURE__*/React__default.createElement(FormLabel$1, {
...
var CustomComboListModal = function CustomComboListModal(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(ConteinerItem, {
    className: "custom-input-select-combo-list-conteiner"
  }, /*#__PURE__*/React__default.createElement(Conteiner, null, /*#__PURE__*/React__default.createElement(ConteinerItem, null, /*#__PURE__*/React__default.createElement(Typography$1, {
    className: "title-table-custom"
