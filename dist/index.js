...
var Header = function Header(_ref) {
  ...
  var renderMenu = /*#__PURE__*/React.createElement(Menu, {
    ...
    fontSize: "small"
  })), "Perfil"), /*#__PURE__*/React.createElement(Divider, null), /*#__PURE__*/React.createElement(MenuItem, {
    onClick: function onClick() {
      return handleExit();
    }
...
var DynaContext = React.createContext();
...
var Agrupamento = function Agrupamento(_ref) {
  ...
  var _useState = React.useState(agrupamento.length > 0 ? agrupamento : defaultGroup),
    tree = _useState[0],
    setTree = _useState[1];
  var _useState2 = React.useState(formatExternalNodes(fields, agrupamento)),
