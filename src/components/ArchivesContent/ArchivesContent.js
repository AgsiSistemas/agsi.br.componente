...
const ArchivesContent = ({
  ...
  const acceptTypesProps = acceptTypes
    ? acceptTypes
    : ['jpg', 'jpeg', 'png', 'pdf']
        ...
        return (
          <Tooltip title='Visualizar PDF'>
            <IconButton>
              <VisibilityIcon
                onClick={() =>
                  showOnApiPdf(file.fileId, file.fileLink, file.fileName)
                }
              />
            </IconButton>
          </Tooltip>
        ...
        return (
          <Tooltip title='Visualizar Imagem'>
            <IconButton>
              <VisibilityIcon
                onClick={() =>
                  showOnApi(file.fileId, file.fileLink, file.fileName)
                }
              />
            </IconButton>
          </Tooltip>
  ...
  const showOnApi = (id, nameArchive) => {
    api.http
      .get(`${api.addressShow(id)}`, { responseType: 'blob' })
